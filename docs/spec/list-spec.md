...
| SPEC-017 | Pipeline Re-extraction and Re-classification | Re-run signal extraction on all 163 Discovered repos with new SBA/Plugin signals, full re-classify, produce comparison report. | 2026-03-06 | — |
...
| SPEC-019 | Deep-Context Re-validation Campaign | Re-run deep-context validation on all 163 repos post-SPEC-017, resolving 30 regressions and validating 41 new entries. Uses Claude Code subagents with Opus. | 2026-03-06 | — |
