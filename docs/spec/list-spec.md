...
| SPEC-006 | Problem-Spaces Cross-Source Rewrite | Rewrite problem-spaces.md (1500+ lines) to classify problems from all 5 sources, expanding KataLog-only profiles to cross-source system profiles. | 2026-03-03 | 1032e4b |
