...
| SPEC-025 | Ecosystem Catalog Schema | Ecosystem entry format + architecture_qualifiers + style-taxonomy.yaml. Foundation for EPIC-010. | 2026-03-10 | 46ab06b |
| SPEC-026 | Ecosystem Curation | Curate 10+ ecosystems, add missing member repos, deep-validate emergent architecture. Depends on SPEC-025. | 2026-03-10 | 46ab06b |
| SPEC-027 | Pipeline Ecosystem Support | Manifest, validation, quality report, frequency analysis updates for ecosystem entries. Depends on SPEC-025. | 2026-03-10 | 46ab06b |
