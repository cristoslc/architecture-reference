...
| SPEC-022 | Pipeline Run and Frequency Recomputation | Recompute production-only frequency rankings with platform/application splits. Modular Monolith #1 (38.7%), Event-Driven #2 (33.1%). | 2026-03-07 | 11e4f397 |
