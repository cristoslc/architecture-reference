...
| EPIC-012 | Catalog Rebalancing and Application Expansion | Remove 43 library/non-software entries, tag all entries with scope/use-type taxonomy (ADR-001), add 30+ production applications to fix 3.4:1 platform-to-application skew, recompute production-only rankings. | 2026-03-06 | 054dab0 |
