...
| EPIC-003 | Architecture Discovery and Scaling | Build automated discovery tooling to classify architecture patterns from repos, then scale the evidence base from 62 to 200+ projects with comparative analysis. | 2026-03-12 | 30ecbf49 |
| EPIC-011 | Platform-Aware Architecture Advising | Enhance the architecture-advisor skill to detect whether the user's context is platform/ecosystem-centric or application-centric, and tailor guidance, trade-off analysis, and style recommendations accordingly. | 2026-03-12 | 30ecbf49 |
| EPIC-013 | ADR-005 Pipeline Unification | Implement ADR-005: make the discover skill the single specification for all pipeline classification. All 4 child specs Implemented; ADR-005 fully realized. | 2026-03-11 | a288b1da |
