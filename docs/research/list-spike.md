...
| SPIKE-002 | Classification Taxonomy Expansion | Do we need architectural classifications beyond the classic 12 styles, and if so, which ones have sufficient evidence? | Pre-implementation gate for EPIC-010 — PIVOT: no new styles, add annotation system | 2026-03-10 | 5568369 |
