...
| SPIKE-005 | Confidence Calibration Prompting | Can we elicit meaningful confidence scores from Gemini 3 Flash instead of uniform 0.95? | Pre-execution gate for SPEC-024 | 2026-03-08 | — |
| SPIKE-006 | LLM CLI Reliability Improvements | Can we improve YAML adherence and use llm's native tool-calling for more robust multi-turn? | Pre-execution gate for SPEC-024 | 2026-03-08 | — |
