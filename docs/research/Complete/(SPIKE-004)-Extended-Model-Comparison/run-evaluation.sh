#!/usr/bin/env bash
# run-evaluation.sh — SPIKE-004 multi-turn classification evaluation
# Forked from pipeline/llm-review.sh, adapted for spike test subjects.
#
# Usage:
...
SYSTEM_PROMPT="${SCRIPT_DIR}/spike-004-system-prompt.md"
...
# ── Main ──────────────────────────────────────────────────────────────────────
main() {
  log "SPIKE-004 Multi-Turn Evaluation"
