...
|------|-------|------|--------------|
| [EPIC-014](../../../epic/Proposed/(EPIC-014)-Architecture-Style-Constraint-Baselines/(EPIC-014)-Architecture-Style-Constraint-Baselines.md) | **Proposed** | Derive per-style structural expectations from the evidence base | None |
