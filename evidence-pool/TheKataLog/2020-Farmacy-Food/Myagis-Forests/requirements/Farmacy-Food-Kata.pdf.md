...
literally and creates tasty mund peoples’ dietary needs and active lifestyles to support their overall
well-being. Our mission is to meals that are radically affordable and accessible.
Farmacy Food mission: https://www.youtube.com/watch?v=9aSLSVAIkoM
Farmacy Food website: https://www.farmacyfood.com/d: Food as Medicine Actualized - Kwaku Osei -
...
Requirements:
   ...
   ● Smart Fridges accessible through the POS systems API’s.Produce item inventory levels and
       purchases. The smart fridges have a cloud based management system that handles
       communication with the Smart Fridge so obtaining this data would be through an API.
   ...
   ● The Kiosk is a sublet space inside another business where we will sell our product but have
       an employee to handle the transactions through a point of sale. The same data should be
...
Important Dates:
   ...
   ●   https://docs.google.com/forms/d/1k4M9zoEOyeamEoCpYlW_URDoCGytjnLugItOw5kNRqI/e
       dit?ts=5f85d981
...
Accessibility (mobile accessible)
...
Smart fridges track inventory / track purchase
Kiosk representative sell products / accept payment / track pickups
Support team provide feedback
System handle payment / register point of sales /
System (Databot) harvest data / machine learning data / serve recommendations
User check availability / purchase an item / pickup at point of sale



Inventory Tracker Purchase Tracker

Payment handler Order placement Order fulfillment

Feedback handler Point of sales Registrator
